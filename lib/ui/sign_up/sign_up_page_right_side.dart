          ...
          child: Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                  image: AssetImage('assets/singHome.png'),
                  fit: BoxFit.cover),
            ),
            child: Center(
              child: SizedBox(
                          ...
                          child: Container(
                            ...
                            child: RichText(
                              ...
                              text: const TextSpan(
                                text: '\n\n\nNo more Guessing,\n',
                                style: TextStyle(
                                  fontSize: 55.0, fontWeight: FontWeight.bold,fontFamily: 'Lobster',color: Color(
                                    0xFF333333)
                                ),
                                children: <TextSpan>[
                                  ...
                                  TextSpan(
                                      ...
                                      fontSize: 55.0,fontWeight: FontWeight.bold,color: Color(
                                          0xFF333333)
                                  )
                                  ),
                                  TextSpan(
