...
class MyBoarder extends StatefulWidget {
  const MyBoarder({Key? key}) : super(key: key);

  @override
  State<MyBoarder> createState() => MyBoarderState();
}

class MyBoarderState extends State<MyBoarder> {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Scaffold(
        backgroundColor:const  Color(0xFF232121),
        appBar: AppBar(title: Text("My Boarder List",style: TextStyle(color: Colors.white,fontSize: 24),),leading:Image.asset("assets/logo.png") ,backgroundColor: const  Color(0xFF232121),),
        body: FutureBuilder(
                        ...
                        child: Card(
                          ...
                          child:ListTile(
                            ...
                            title: Column(
                              ...
                              children: [
                                Text("Sasindu Sahan",style: TextStyle(fontSize: 22,color: Colors.white),),
                                SizedBox(height: 10,),
                                Row(
                                  children: [
                                    Text("Contact : 0770610851",style: TextStyle(color: Colors.white,fontSize: 13),),
                                    SizedBox(width: 5,),
                                    // Text("Date of Birth :${boarders.data[index].dob}",style: TextStyle(color: Colors.white,fontSize: 10),),
                                    // SizedBox(width: 5,),
                                    Text("Gender : Male",style: TextStyle(color: Colors.white,fontSize: 13),),
                                    SizedBox(width: 10,),
                                ...
                                Row(
                                  children: [
                                    SizedBox(width: 150,),
                                    FloatingActionButton.extended(onPressed: (){},icon:Icon(Icons.sms_failed_outlined,color:fontYellow),label:Text("Remove",style: TextStyle(color: fontYellow,fontSize: 13),),backgroundColor: Colors.red.withOpacity(0.25),),
                                    // SizedBox(width: 10,),
